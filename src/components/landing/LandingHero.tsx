    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-16 pt-16 sm:pb-20 sm:pt-20 lg:grid lg:grid-cols-2 lg:items-center lg:gap-12 lg:pb-24 lg:pt-24">
        <div>
          ...
          >
            Gestão em saúde{" "}
            <span className="landing-gradient-text">sem burocracia</span>
          </h1>
          ...
          <p className="landing-fade-in mt-4 max-w-xl text-sm text-white/55">
            Cada clínica opera com marca própria — logo, cores e domínio — sobre a
            infraestrutura {branding.displayName}.
          </p>

          <div className="landing-fade-in mt-10 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Link
              href="#portais"
              className="group inline-flex items-center justify-center gap-2 rounded-[var(--radius-button)] bg-[var(--brand-accent)] px-6 py-3.5 text-base font-semibold text-[var(--surface-inverse)] shadow-lg shadow-teal-900/30 transition hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
            >
              Explorar portais
              <LandingIcon
                name="arrow-right"
