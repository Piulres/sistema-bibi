...
export const INTERNO_NAV_TABS: NavTab[] = [
  ...
  { href: "/interno/gestao", label: "Gestão clínica", key: "gestao" },
...
export function resolveInternoActive(pathname: string): InternoModule | undefined {
  ...
  if (pathname.startsWith("/interno/gestao")) return "gestao";
  ...
  if (pathname.startsWith("/interno/assistente")) return "assistente";
  return undefined;
}
