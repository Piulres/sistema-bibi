...
export const CRUD_OPERATIONS_MAP: CrudEntityMap[] = [
  ...
  },
  {
    ...
    create: none,
    read: [
      download("PDF/Excel faturamento", "/interno/relatorios", "GET /api/interno/reports?type=billing&format=pdf|xlsx"),
      download("PDF/Excel CRM", "/interno/relatorios", "GET /api/interno/reports?type=crm&format=pdf|xlsx"),
      ...
      download("Export faturamento", "/interno → Faturamento", "GET /api/interno/billing/export"),
      download("Export auditoria", "/interno/auditoria", "GET /api/interno/audit/export"),
      download("Export assinaturas", "/interno/assinaturas", "GET /api/interno/subscriptions/export"),
      download("PDF fatura/boleto", "/interno → Faturamento", "GET /api/interno/invoices/[id]/export"),
      download("PDF PEP", "/interno/beneficiarios/[id]", "GET /api/interno/patients/[id]/records/[recordId]/export"),
      download("Cliente 360° PDF/Excel", "/interno/beneficiarios/[id]", "GET /api/interno/patients/[id]/export?section="),
      download("Export LGPD JSON", "/interno/beneficiarios/[id]", "GET /api/interno/patients/[id]/export?format=json"),
  ...
  // —— Beneficiário ——
  {
    ...
    read: [
      ...
      download("PDF/Excel por seção", "/beneficiario/*", "GET /api/beneficiario/export?section="),
      download("PDF fatura", "/beneficiario/faturas", "GET /api/beneficiario/invoices/[id]/export"),
    ],
    update: [
  ...
  // —— PJ ——
  {
    ...
    create: [
      ...
      ui("Incluir colaborador", "/pj → Beneficiários", "POST /api/pj/beneficiaries"),
    ],
    read: [
    ...
    update: [apiOnly("Editar colaborador", "PATCH /api/pj/beneficiaries/[id]")],
    delete: [apiOnly("Desvincular colaborador", "DELETE /api/pj/beneficiaries/[id]")],
  },
  {
    entity: "Relatório corporativo",
    portal: "PJ",
    create: none,
    read: [download("PDF/Excel/CSV", "/pj", "GET /api/pj/reports?format=")],
    update: none,
    delete: none,
  },
