...
**Validação v2.3.0 (dev, jun/2026):** [`V2_3_VALIDACAO_DEV.md`](V2_3_VALIDACAO_DEV.md) — onboarding fase 2, micro-tours, OpenAPI, segmento Build. **Produção atual:** v2.3.1 — [`RELEASES.md`](../versoes/RELEASES.md).
