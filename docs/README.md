...
> **Produção:** **v3.0.21** @ https://sistema-bibi.netlify.app · deploy `bibi-poc-2026-07-27m` (`6a6708db` @ `d9bd043`) · [`versoes/RELEASES.md`](versoes/RELEASES.md) · changelog [`versoes/V3_0.md`](versoes/V3_0.md) · PWA [`/instalar`](https://sistema-bibi.netlify.app/instalar).

> **Última revisão factual:** 27/07/2026 — produção **v3.0.21** (`bibi-poc-2026-07-27m` @ `d9bd043`): documentos de saída (melhores práticas) + fix assistente (`ruleOverrides` no runtime) — ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
