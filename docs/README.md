...
> **Produção:** **v3.0.12** @ https://sistema-bibi.netlify.app · deploy `bibi-poc-2026-07-27c` (`6a66c080` @ `e5c1f50`) · [`versoes/RELEASES.md`](versoes/RELEASES.md) · changelog [`versoes/V3_0.md`](versoes/V3_0.md) · PWA [`/instalar`](https://sistema-bibi.netlify.app/instalar).

> **Última revisão factual:** 27/07/2026 — produção **v3.0.12** (`bibi-poc-2026-07-27c` @ `e5c1f50`): Dashboard KPIs claros — ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
