...
> **Última revisão factual:** 27/07/2026 — produção **v3.0.18** (`bibi-poc-2026-07-27i` @ `372b5cc`): Estoque Fase 3 (SEM-LOTE) + Assistente motor de regras — ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
...
| [`produto/ASSISTENTE_REGRAS_PLANO.md`](produto/ASSISTENTE_REGRAS_PLANO.md) | Motor de regras, IA híbrida e painel `/interno/assistente` |
...
| Documento | Conteúdo |
|-----------|----------|
| [`versoes/RELEASES.md`](versoes/RELEASES.md) | Pacotes fechados — **v3.0.18 em produção** |
