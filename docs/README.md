# Documentação Sistema Bibi - ServiceOS v3.0.27
...
> **Produção:** **v3.0.27** @ https://sistema-bibi.netlify.app · deploy `6a679eaf` @ `01ca7eb` · [`versoes/RELEASES.md`](versoes/RELEASES.md) · changelog [`versoes/V3_0.md`](versoes/V3_0.md) · PWA [`/instalar`](https://sistema-bibi.netlify.app/instalar).

> **Última revisão factual:** 27/07/2026 — produção **v3.0.27** (`6a679eaf` @ `01ca7eb`): BrandMark visível na home (`useThemeColors` + mesh) — ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
