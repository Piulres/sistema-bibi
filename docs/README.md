...
> **Produção:** **v2.4.0** @ https://sistema-bibi.netlify.app — [`versoes/RELEASES.md`](versoes/RELEASES.md) · pacote código **v2.5.0** ([`versoes/V2_5.md`](versoes/V2_5.md), pendente deploy).
...
| Documento | Conteúdo |
|-----------|----------|
| [`versoes/RELEASES.md`](versoes/RELEASES.md) | Pacotes fechados — **v2.4.0 em produção** · **v2.5.0** pendente |
