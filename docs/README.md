...
> **Produção:** **v3.0.19** @ https://sistema-bibi.netlify.app · deploy `bibi-poc-2026-07-27j` (`6a66f3a7` @ `1fca530`) · [`versoes/RELEASES.md`](versoes/RELEASES.md) · changelog [`versoes/V3_0.md`](versoes/V3_0.md) · PWA [`/instalar`](https://sistema-bibi.netlify.app/instalar).

> **Última revisão factual:** 27/07/2026 — produção **v3.0.19** (`bibi-poc-2026-07-27j` @ `1fca530`): Assistente Fase 3 (CRUD `ruleOverrides`) + marca whitelabel — ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
...
| [`plataforma/DESIGN_SYSTEM.md`](plataforma/DESIGN_SYSTEM.md) | Tokens, white label, `BrandMark` |
| [`plataforma/BRANDING.md`](plataforma/BRANDING.md) | Energia Brasileira + marca circular PWA |
...
| [`produto/ASSISTENTE_SERVERLESS.md`](produto/ASSISTENTE_SERVERLESS.md) | Chat serverless (tokens HMAC, JTI) |
| [`produto/ASSISTENTE_REGRAS_PLANO.md`](produto/ASSISTENTE_REGRAS_PLANO.md) | Motor de regras, Fase 3 CRUD, roadmap IA |
