...
> **Última revisão factual:** 27/07/2026 — pacote **v3.0.24** na `dev` (BrandMark + nav Mais + assistente); produção ainda **v3.0.23** — ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
