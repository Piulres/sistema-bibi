...
> **Produção:** **v3.0.19** @ https://sistema-bibi.netlify.app · deploy `6a66f3a7` @ `1fca530` (`bibi-poc-2026-07-27j`) · [`versoes/RELEASES.md`](versoes/RELEASES.md) · changelog [`versoes/V3_0.md`](versoes/V3_0.md) · PWA [`/instalar`](https://sistema-bibi.netlify.app/instalar).

> **Última revisão factual:** 27/07/2026 — produção **v3.0.19**; pacote **v3.0.20** em `main`/`dev` (estoque F4 + assistente híbrido + Capacitor B + PJ agendar) **pendente de deploy** — ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
