...
> **Última revisão factual:** 26/07/2026 — produção **v3.0.4** (`bibi-poc-2026-07-26d`); TISS 422 em [`produto/FLUXOS.md`](produto/FLUXOS.md) §4.1 · contrato API em [`plataforma/API_DOCS.md`](plataforma/API_DOCS.md) §6 · OpenAPI **123 paths / 160 handlers** em [`plataforma/ARQUITETURA.md`](plataforma/ARQUITETURA.md) §20 · `pre-release` e `cursor:verify` em [`plataforma/WORKFLOW_CURSOR.md`](plataforma/WORKFLOW_CURSOR.md).
