# Documentação Sistema Bibi - ServiceOS v3.0.28
...
> **Produção:** **v3.0.28** @ https://sistema-bibi.netlify.app · deploy `pendente` @ `pendente` · [`versoes/RELEASES.md`](versoes/RELEASES.md) · changelog [`versoes/V3_0.md`](versoes/V3_0.md) · PWA [`/instalar`](https://sistema-bibi.netlify.app/instalar).

> **Última revisão factual:** 27/07/2026 — pacote **v3.0.28** (nav pills, PWA laranja, BIBI) — produção atual ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
...
| Documento | Conteúdo |
|-----------|----------|
| [`versoes/RELEASES.md`](versoes/RELEASES.md) | Pacotes fechados — **v3.0.28 em produção** |
