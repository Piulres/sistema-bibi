# Documentação Sistema Bibi - ServiceOS v3.0.26
...
> **Produção:** **v3.0.26** @ https://sistema-bibi.netlify.app · deploy `6a679550` @ `822b65e` · [`versoes/RELEASES.md`](versoes/RELEASES.md) · changelog [`versoes/V3_0.md`](versoes/V3_0.md) · PWA [`/instalar`](https://sistema-bibi.netlify.app/instalar).

> **Última revisão factual:** 27/07/2026 — produção **v3.0.26** (`6a679550` @ `822b65e`): monograma **Bibi** na home + import CSV PJ — ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
