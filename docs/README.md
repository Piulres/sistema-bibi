...
> **Produção:** **v3.0.13** @ https://sistema-bibi.netlify.app · próximo pacote **v3.0.14** na `dev` · [`versoes/RELEASES.md`](versoes/RELEASES.md) · changelog [`versoes/V3_0.md`](versoes/V3_0.md) · PWA [`/instalar`](https://sistema-bibi.netlify.app/instalar).

> **Última revisão factual:** 27/07/2026 — pacote **v3.0.14** preparado (hotfix downloads Gestão clínica) — ver [`versoes/RELEASES.md`](versoes/RELEASES.md).
