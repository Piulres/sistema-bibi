...
**Ordem:** a primeira entrada de `CHANGELOG_RELEASES` deve ser a versão `current` (hoje **3.0.1**).

---

## Exemplo — promover v3.0.0 → v3.0.1
...
{
  version: "3.0.0",
  label: "Sistema Bibi - ServiceOS v3.0",
  status: "previous",
  // ...
},
```
...
- `PLATFORM.version` é prefixo da versão current (ex.: `"3.0"` ↔ `"3.0.1"`)
