...
Exemplo atual em produção: **`v3.0.16`** — reagendar + Assistente Fase 0 + estoque UI (`bibi-poc-2026-07-27g`). Ver [`RELEASES.md`](../versoes/RELEASES.md).
...
**Produção:** https://sistema-bibi.netlify.app · **v3.0.16** · modo **operação** (CEDIG) · Stop builds **ON**  
