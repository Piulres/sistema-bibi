...
Exemplo atual em produção: **`v3.0.14`** — auditoria RBAC + estoque + cadastros + documentos de saída (`bibi-poc-2026-07-27e`). Ver [`RELEASES.md`](../versoes/RELEASES.md).
...
**Produção:** https://sistema-bibi.netlify.app · **v3.0.14** · modo **operação** (CEDIG) · Stop builds **ON**  
