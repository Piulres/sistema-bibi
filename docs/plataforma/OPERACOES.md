...
Exemplo atual em produção: **`v3.0.10`** — mês operacional + agenda/calendário (`bibi-poc-2026-07-27a`). Ver [`RELEASES.md`](../versoes/RELEASES.md).
...
**Produção:** https://sistema-bibi.netlify.app · **v3.0.10** · modo **operação** (CEDIG) · Stop builds **ON**  
