...
Exemplo atual em produção: **`v3.0.17`** — RBAC clínico 360° + a11y + auto-confirm (`bibi-poc-2026-07-27h`). Ver [`RELEASES.md`](../versoes/RELEASES.md).
...
**Produção:** https://sistema-bibi.netlify.app · **v3.0.17** · modo **operação** (CEDIG) · Stop builds **ON**  
