...
Exemplo atual em produção: **`v3.0.7`** — drawer mobile direita, dashboard executivo, exports canônicos. Ver [`RELEASES.md`](../versoes/RELEASES.md).
...
**Produção:** https://sistema-bibi.netlify.app · **v3.0.7** · modo **operação** (CEDIG) · Stop builds **ON**  
