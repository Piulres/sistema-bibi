...
Exemplo atual em produção: **`v2.4.0`** — **Sistema Bibi - ServiceOS** (CEDIG gestão clínica). Ver [`RELEASES.md`](../versoes/RELEASES.md).
...
**Produção:** https://sistema-bibi.netlify.app · **v2.4.0** · modo **operação** (CEDIG) · Stop builds **ON**  
