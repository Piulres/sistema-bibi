...
Exemplo atual em produção: **`v3.0.5`** — **Sistema Bibi - ServiceOS** (PWA `/instalar` + atendimento clínico + jornada faturada + UX landing/portais). Ver [`RELEASES.md`](../versoes/RELEASES.md).
