...
Exemplo atual em produção: **`v3.0.6`** — **Sistema Bibi - ServiceOS** (home comercial + nav portais + assistente). Ver [`RELEASES.md`](../versoes/RELEASES.md).
...
**Produção:** https://sistema-bibi.netlify.app · **v3.0.6** · modo **operação** (CEDIG) · Stop builds **ON**  
