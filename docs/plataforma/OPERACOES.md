...
Exemplo atual em produção: **`v3.0.0`** — **Sistema Bibi - ServiceOS** (PWA `/instalar` + empilha CEDIG/login v2.6). Ver [`RELEASES.md`](../versoes/RELEASES.md).
...
**Produção:** https://sistema-bibi.netlify.app · **v3.0.0** · modo **operação** (CEDIG) · PWA [`/instalar`](https://sistema-bibi.netlify.app/instalar) · Stop builds **ON**  
