...
Exemplo atual em produção: **`v3.0.8`** — jornada consultório + reset operacional CEDIG. Ver [`RELEASES.md`](../versoes/RELEASES.md).
...
**Produção:** https://sistema-bibi.netlify.app · **v3.0.8** · modo **operação** (CEDIG) · Stop builds **ON**  
