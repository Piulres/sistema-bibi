...
**Produção (26/07/2026):** **v3.0.5** em Netlify (`bibi-poc-2026-07-26e` @ `cf0eb26`) · **`main`/`dev` v3.0.6** · ver [`../versoes/RELEASES.md`](../versoes/RELEASES.md). Escopo: [`../versoes/V3_0.md`](../versoes/V3_0.md) · CEDIG/pontes: [`../versoes/V2_6.md`](../versoes/V2_6.md) · login: [`../versoes/V2_5.md`](../versoes/V2_5.md).
