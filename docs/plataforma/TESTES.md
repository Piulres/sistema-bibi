...
**Ground truth (jun/2026):** **410** casos Vitest · **130** testes Playwright E2E (10 specs × 2 projetos; 121 passando na última execução local) · **~121** Route Handlers · **73** paths no OpenAPI (`public/openapi.yaml`).
