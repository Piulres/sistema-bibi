...
| RBAC interno / guards API | `FLUXOS.md` §4.9/§9 · `AUDITORIA_FLUXOS.md` §5 · `tests/security/rbac-gaps.test.ts` · `tests/api/patient-clinical-rbac.test.ts` |
| A11y (focus trap, tab order) | `DESIGN_SYSTEM.md` §Acessibilidade · `tests/unit/a11y-focus.test.ts` |
