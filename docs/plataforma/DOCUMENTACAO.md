...
|---------------------|-----------|
| Prontuário / Care Chart / protocolos / equipe / receita multi-item | `DOCUMENTOS_CLINICOS.md` · `FLUXOS.md` §3/§4.3 · `API_DOCS.md` §7 |
...
| Exports tabulares / `ExportButtons` / `DownloadLink` | `FLUXOS.md` §4.11 · `API_DOCS.md` §9 · `DESIGN_SYSTEM.md` §Exports · `src/lib/ui/download-export.ts` |
