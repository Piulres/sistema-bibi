...
| Assistente (chat, regras, IA híbrida) | `ASSISTENTE_SERVERLESS.md` · `ASSISTENTE_REGRAS_PLANO.md` · `VARIAVEIS_AMBIENTE.md` §Assistente |
| Documentos clínicos / guias PDF | `DOCUMENTOS_CLINICOS.md` · `FLUXOS.md` §4.3 · `API_DOCS.md` §7 |
