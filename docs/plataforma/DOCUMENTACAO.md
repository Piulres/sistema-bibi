...
| Landing nav / marca / changelog home | `DESIGN_SYSTEM.md` · `BRANDING.md` (BrandMark, `useThemeColors`, `PLATFORM.brandMark`) · `LANDING_CHANGELOG.md` · `src/lib/landing/navigation.ts` |
| BrandMark whitelabel (PWA, headers, OG) | `BRANDING.md` · `src/lib/brand/brand-mark.ts` · `npm run icons:generate` |
