...
|---------------------|-----------|
| Prontuário / Care Chart / protocolos / receita multi-item / equipe | `DOCUMENTOS_CLINICOS.md` · `FLUXOS.md` §3/§4.3 · `API_DOCS.md` §7 |
...
| Exports tabulares / `ExportButtons` / `DownloadLink` | `FLUXOS.md` §4.11 · `DESIGN_SYSTEM.md` §Exports · `API_DOCS.md` §9 · `src/lib/ui/download-export.ts` |
| CI Job Summary / reporters Vitest-Playwright | `TESTES.md` §CI · `.cursor/rules/tests.mdc` · `scripts/ci-vitest-summary.mjs` |
