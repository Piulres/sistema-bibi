...
| Pacote em produção | **`v3.0.19`** — deploy `6a66f3a7` @ `1fca530` (`bibi-poc-2026-07-27j`) — ver [`RELEASES.md`](../versoes/RELEASES.md) |
| Pacote preparado (`main`/`dev`) | **`v3.0.20`** — estoque F4 + assistente híbrido + Capacitor B + PJ agendar — **pendente deploy** |
| Pacote anterior | **`v3.0.18`** — deploy `6a66e9d6` @ `372b5cc` (`bibi-poc-2026-07-27i`) |
| Tags git | ✅ `v2.4.0` … `v3.0.20` (tag registrada; deploy ainda v3.0.19) |
