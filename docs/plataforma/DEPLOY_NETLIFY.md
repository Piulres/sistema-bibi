...
| Pacote em produção | **`v3.0.25`** — deploy `6a678e1a` @ `368d83b` — ver [`RELEASES.md`](../versoes/RELEASES.md) |
| Pacote anterior | **`v3.0.24`** — deploy `6a677dc5` @ `15275c0` |
| `main` / `dev` | **v3.0.25** · sincronizadas @ `368d83b` |
| Tags git | ✅ `v2.4.0` … `v3.0.25` |
