...
| Pacote em produção | **`v2.3.1`** — patch title/footer + `PLATFORM.release` (`bibi-poc-2026-07-25b`) |
| Pacote anterior | **`v2.3.0`** — deploy `6a6436ef` @ `374b13e` (`bibi-poc-2026-07-25a`) |
| `main` / `dev` | Sincronizadas · tip `v2.3.1` |
