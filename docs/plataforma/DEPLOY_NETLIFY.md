...
| Pacote em produção | **`v3.0.20`** — deploy `6a66fe7f` @ `1132880` (`bibi-poc-2026-07-27k`) — ver [`RELEASES.md`](../versoes/RELEASES.md) |
| Pacote anterior | **`v3.0.19`** — deploy `6a66f3a7` @ `1fca530` (`bibi-poc-2026-07-27j`) |
| `main` / `dev` | **v3.0.20** · sincronizadas @ `1132880` |
