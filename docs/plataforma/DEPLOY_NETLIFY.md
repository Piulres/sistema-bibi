...
| Pacote em produção | **`v3.0.6`** — deploy `6a65cf36` @ `ed14233` (`bibi-poc-2026-07-26f`) |
| Pacote anterior | **`v3.0.5`** — deploy `6a65c17d` @ `cf0eb26` (`bibi-poc-2026-07-26e`) |
| `main` / `dev` | **v3.0.6** · sincronizadas @ `ed14233` |
| Tags git | ✅ `v2.4.0` … `v3.0.6` |
