...
| Pacote em produção | **`v3.0.26`** — deploy `6a679550` @ `822b65e` — ver [`RELEASES.md`](../versoes/RELEASES.md) |
| Pacote anterior | **`v3.0.25`** — deploy `6a678e1a` @ `368d83b` |
| `main` / `dev` | **v3.0.26** · sincronizadas @ `822b65e` |
| Tags git | ✅ `v2.4.0` … `v3.0.26` |
