...
| Pacote em produção | **`v3.0.14`** — deploy `6a66db43` @ `59700b5` (`bibi-poc-2026-07-27e`) — ver [`RELEASES.md`](../versoes/RELEASES.md) |
| Pacote anterior | **`v3.0.13`** — deploy `6a66d114` @ `78b575f` (`bibi-poc-2026-07-27d`) |
| `main` / `dev` | **v3.0.14** · sincronizadas @ `59700b5` |
| Tags git | ✅ `v2.4.0` … `v3.0.14` |
