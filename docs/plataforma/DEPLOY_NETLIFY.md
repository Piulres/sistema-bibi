...
| Pacote em produção | **`v3.0.9`** — deploy `6a669510` @ `0bd89b2` (`bibi-poc-2026-07-26j`) — ver [`RELEASES.md`](../versoes/RELEASES.md) |
| Pacote anterior | **`v3.0.8`** — deploy `6a668d13` @ `5c94251` (`bibi-poc-2026-07-26i`) |
| `main` / `dev` | **v3.0.9** · sincronizadas @ `0bd89b2` |
| Tags git | ✅ `v2.4.0` … `v3.0.9` |
