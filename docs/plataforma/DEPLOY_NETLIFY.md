...
| Pacote em produção | **`v3.0.10`** — `bibi-poc-2026-07-27a` @ `b9ff9cb` — ver [`RELEASES.md`](../versoes/RELEASES.md) |
| Pacote anterior | **`v3.0.9`** — deploy `6a669510` @ `0bd89b2` (`bibi-poc-2026-07-26j`) |
| `main` / `dev` | **v3.0.10** · sincronizadas @ `b9ff9cb` |
| Tags git | ✅ `v2.4.0` … `v3.0.10` |
