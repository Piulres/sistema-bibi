...
| Pacote em produção | **`v3.0.17`** — deploy `6a66e5f9` @ `c3eb563` (`bibi-poc-2026-07-27h`) — ver [`RELEASES.md`](../versoes/RELEASES.md) |
| Pacote anterior | **`v3.0.16`** — deploy `6a66e115` @ `9e98494` (`bibi-poc-2026-07-27g`) |
| `main` / `dev` | **v3.0.17** · sincronizadas @ `c3eb563` |
| Tags git | ✅ `v2.4.0` … `v3.0.17` |
