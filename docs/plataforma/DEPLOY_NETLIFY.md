...
| Walk-in some na agenda (modo demo) | SQLite efêmero em `/tmp` por instância Lambda | Alternar para **modo operação** em `/interno/seguranca`; a agenda exibe aviso `walkInEphemeral` |
