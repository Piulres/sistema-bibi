...
| Pacote em produção | **`v3.0.1`** — deploy `6a6594ac` @ `daf690e` (`bibi-poc-2026-07-26a`) |
| Pacote anterior | **`v3.0.0`** — deploy `6a654c88` @ `e30fc70` (`bibi-poc-2026-07-25k`) |
| `main` / `dev` | Sincronizadas · tag `v3.0.1` |
| Tags git | ✅ `v2.4.0` · `v2.5.0` · `v2.6.0` · `v3.0.0` · `v3.0.1` |
