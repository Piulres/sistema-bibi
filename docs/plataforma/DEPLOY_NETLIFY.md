...
| Pacote em produção | **`v2.4.0`** — deploy `6a6462dc` @ `527fe03` (`bibi-poc-2026-07-25d`) · modo **operação** |
| Pacote anterior | **`v2.3.1`** — deploy `6a643a0d` @ `12148ce` (`bibi-poc-2026-07-25b`) |
| `main` / `dev` | Sincronizadas · **v2.4.0** · tag `v2.4.0` |
| Tags git | ✅ `v2.2.0` · `v2.3.0` · `v2.3.1` · `v2.4.0` |
