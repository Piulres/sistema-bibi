...
| Pacote em produção | **`v3.0.7`** — deploy `6a65eac9` @ `25385b2` (`bibi-poc-2026-07-26h`) |
| Pacote anterior | **`v3.0.6`** — deploy `6a65cf36` @ `ed14233` (`bibi-poc-2026-07-26f`) |
| `main` / `dev` | **v3.0.7** · sincronizadas @ `25385b2` |
| Tags git | ✅ `v2.4.0` … `v3.0.7` |
