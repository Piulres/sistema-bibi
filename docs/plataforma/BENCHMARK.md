...
Última revisão: **ServiceOS v3.0.25** — multi-nicho desde v2.0 (`useLabels()`, landing comercial, BrandMark whitelabel, import CSV PJ, nav Mais portaled, jornada consultório, drawer mobile, exports canônicos, 7 segmentos incl. CONSTRUCTION).
