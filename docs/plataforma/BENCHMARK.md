...
Última revisão: **ServiceOS v3.0.7** — multi-nicho desde v2.0 (`useLabels()`, landing comercial, drawer mobile direita, exports canônicos, 7 segmentos incl. CONSTRUCTION).
