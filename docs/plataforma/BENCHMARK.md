...
Última revisão: **ServiceOS v3.0.16** — multi-nicho desde v2.0 (`useLabels()`, landing comercial, jornada consultório, reagendar beneficiário, assistente Fase 0, 7 segmentos incl. CONSTRUCTION).
