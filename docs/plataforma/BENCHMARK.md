...
Última revisão: **ServiceOS v3.0.17** — multi-nicho desde v2.0 (`useLabels()`, landing comercial, jornada consultório, drawer mobile direita, exports canônicos, 7 segmentos incl. CONSTRUCTION).
