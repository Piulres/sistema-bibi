...
Última revisão: **ServiceOS v3.0.26** em produção — ver [`../versoes/RELEASES.md`](../versoes/RELEASES.md). Narrativa operacional: [`JORNADA_CONSULTORIO.md`](JORNADA_CONSULTORIO.md). Pacotes recentes: monograma Bibi na home, import CSV PJ, BrandMark whitelabel, nav Mais portaled, CRUD colaboradores PJ, RBAC Fase 5, exports canônicos (v3.0.7+).
