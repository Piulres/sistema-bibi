...
Última revisão: **ServiceOS v3.0.5** (base multi-nicho desde v2.0) — jornada faturada no prestador, labels por tenant, landing segmentada, tenants demo multi-nicho.
