...
Última revisão: **ServiceOS v3.0.28** em produção — ver [`../versoes/RELEASES.md`](../versoes/RELEASES.md). Narrativa operacional: [`JORNADA_CONSULTORIO.md`](JORNADA_CONSULTORIO.md). Pacotes recentes: BrandMark whitelabel, nav Mais portaled, CRUD/import CSV PJ, RBAC Fase 5, exports canônicos (v3.0.7+).
