...
| **Produto** | Sistema Bibi - ServiceOS **v3.0.27** · produção `6a679eaf` |
...
| Pacote em produção | ✅ | **v3.0.27** · BrandMark mesh na home + import CSV PJ |
...
|------|--------|----------|
| 2026-07-27 | Pacote **v3.0.27** em produção: BrandMark visível na home (`useThemeColors` + mesh) · deploy `6a679eaf` | ✅ |
