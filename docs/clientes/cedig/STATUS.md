...
| **Produto** | Sistema Bibi - ServiceOS **v3.0.17** (preparado) · produção ainda `6a66e115` (v3.0.16) |
...
| Pacote em produção | ✅ | **v3.0.16** · **v3.0.17** preparado (RBAC clínico + a11y + auto-confirm) |
