...
> Pacote **v3.0.16** — reagendar + Assistente Fase 0 (+ estoque Fase 2 UI no tip) **em produção**.

| Item | Valor |
|------|-------|
| **Versão em produção (sistema-bibi.netlify.app)** | **3.0.16** — deploy `6a66e115` @ `cbec2c7` (`bibi-poc-2026-07-27g`) |
...
|-----|---------------|----------|
| **`v3.0.16`** | `cbec2c7` | Reagendar beneficiário + Assistente Fase 0 · deploy `6a66e115` · #282/#286/#306 |
