...
> Pacote **v3.0.16** — reagendar + Assistente Fase 0 + estoque Fase 2 UI **pendente de deploy**.
...
- **Qualidade:** `scheduling-reschedule` · `assistant-*` · `stock` / `stock-constants` · CI #282/#286/#306/#308 · pre-release OK.
