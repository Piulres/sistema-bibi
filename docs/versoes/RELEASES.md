...
> Pacote **v3.0.20** — Assistente Fase 4 + Estoque Fase 4 + Capacitor Fase B **pendente deploy**.
...
|----------|--------|----------|
| **Integração** | `dev` | **v3.0.20** (Fase 4 assistente + estoque + Capacitor) |
...
- **Assistente Fase 4:** pipeline híbrido `refineHybridPlan` — LLM → allowlist regras → tools (#337).
- **Estoque Fase 4:** reversão idempotente e integridade de lote (#338).
- **Capacitor Fase B:** scaffold iOS/Android + service worker shell (#340).
- **Qualidade:** `assistant-hybrid` · `stock` · `pwa-mobile-shell` · CI #337/#338/#340 · pre-release OK.
