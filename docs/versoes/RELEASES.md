...
| **Release `main` / `dev`** | **v3.0.4** · tip `fd22ebc` |
...
|-----|---------------|----------|
| **`v3.0.4`** | `fd22ebc` | TISS 422 + config Cursor enxuta + docs schema-sync (#212/#218/#219) |
...
| **3.0.x** | [`V3_0.md`](V3_0.md) | ✅ **`v3.0.4` em produção** — TISS + cursor + docs schema-sync |
