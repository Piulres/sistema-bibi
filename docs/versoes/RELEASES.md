...
- **Portal PJ:** CRUD colaboradores — `POST/PATCH/DELETE /api/pj/beneficiaries` + UI `/pj` (#365).
...
- **Qualidade:** `documentos-saida` · `clinical-discharge` · `assistant-hybrid` · pre-release OK · deploy `6a670ad1`.
...
| **3.0.x** | [`V3_0.md`](V3_0.md) | ✅ **`v3.0.25` em produção** — import CSV PJ + qualidade estoque/CEDIG · deploy `6a678e1a` |
