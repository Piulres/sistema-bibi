...
| Item | Valor |
|------|-------|
| **Versão em produção (sistema-bibi.netlify.app)** | **3.0.21** — deploy `6a6708db` @ `d9bd043` (`bibi-poc-2026-07-27m`) |
...
| **Netlify** | **sistema-bibi.netlify.app** | **v3.0.21** · deploy `6a6708db` · HTTP 200 · **Stop builds ON** |
...
- **Qualidade:** `documentos-saida` · `clinical-discharge` · `assistant-hybrid` · pre-release OK · deploy `6a6708db`.

### Smoke (27/07/2026) — produção v3.0.21

| Check | Resultado |
|-------|-----------|
| Landing `/` | 200 · footer `v3.0.21` · deploy `6a6708db` |
...
- **Assistente hotfix:** `ruleOverrides` no runtime do chat + gateway no modo IA sem `ASSISTANT_PROVIDER` (#343/#348) · tip `6a6702f7`.
...
| Check | Resultado |
|-------|-----------|
| Landing `/` | 200 · footer `v3.0.20` · deploy `6a6702f7` |
| CSS `/_next/static/chunks/*.css` | 200 |
| `/interno/login` | 200 |
| `/pj` | 307 (auth) |
| `/interno/assistente` | 307 (auth) |
...
- **Qualidade:** fix jornada consultório uniqueSlot/400 (#329) · `assistant-rule-engine` · `brand-mark` · CI #325/#329/#330 · pre-release OK · deploy `6a66f3a7`.

### Smoke (27/07/2026) — produção v3.0.19

| Check | Resultado |
|-------|-----------|
| Landing `/` | 200 · footer `v3.0.19` · deploy `6a66f3a7` |
| CSS `/_next/static/chunks/*.css` | 200 |
| `/login` · `/interno/login` | 200 |
| `/interno/assistente` | 307 (auth) |
| Cota Netlify | sem `503 usage_exceeded` |
...
- **Qualidade:** `audit-access`, `audit-rbac-content`, `stock` · `cadastros-resolve-tab` · `documentos-saida` · CI #291/#293/#296/#299 verdes · pre-release OK · deploy `6a66db43`.
...
| **`v3.0.21`** | `d9bd043` | Documentos de saída · deploy `6a6708db` · #342/#343 |
...
| **3.0.x** | [`V3_0.md`](V3_0.md) | ✅ **`v3.0.21` em produção** — documentos de saída · deploy `6a6708db` |
