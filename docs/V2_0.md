...
|------|-------|
| **Codinome** | ServiceOS |
| **Tag git** | **`v2.0.0`** (`e823fe4`) — criada 23/06/2026 |
| **Branch** | `main` / `dev` sincronizadas em v2.0.0 |
| **Produção atual** | **v1.2.0** (deploy `6a39d446`) — v2.0 **não publicada** na Netlify |
...
| [`RELEASES.md`](RELEASES.md) | v2.0 validado + tag; deploy pendente |
...
5. Deploy manual v2.0.0 → atualizar `RELEASES.md` (tag já criada; falta Netlify).
