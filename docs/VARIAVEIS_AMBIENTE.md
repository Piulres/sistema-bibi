...
Arquitetura da massa, catálogo de preços e perfis por setor: [`SEED.md`](SEED.md).
...
| `SEED_SCALE` | `prisma/seed-data/scale.ts` — ver [`SEED.md`](SEED.md) |
...
- [`docs/SEED.md`](SEED.md) — massa demo e precificação de mercado
