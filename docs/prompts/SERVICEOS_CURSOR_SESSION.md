...
```markdown
# Contexto — Sistema Bibi - ServiceOS v3.0.6

Você trabalha no **Sistema Bibi - ServiceOS v3.0.6** — infraestrutura SaaS **multi-segmento** Pay Per Use (PWA `/instalar` em produção).
