...
```markdown
# Contexto — Sistema Bibi - ServiceOS v3.0.27

Você trabalha no **Sistema Bibi - ServiceOS v3.0.27** — infraestrutura SaaS **multi-segmento** Pay Per Use (PWA `/instalar` em produção).
