...
```markdown
# Contexto — Sistema Bibi - ServiceOS v3.0.25

Você trabalha no **Sistema Bibi - ServiceOS v3.0.25** — infraestrutura SaaS **multi-segmento** Pay Per Use (PWA `/instalar` em produção).
