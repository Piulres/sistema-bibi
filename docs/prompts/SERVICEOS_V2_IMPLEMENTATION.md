...
Atue como Engenheiro de Software Sênior no **Sistema Bibi - ServiceOS** (**v3.0.17** em produção; base multi-nicho desde v2.0) — infraestrutura horizontal **Pay Per Use multi-segmento**:
...
| `CONSTRUCTION` | Engenharia | `build` |

**ROI de referência (saúde corporativa):** 500 colaboradores — ~R$ 175k/mês (tradicional) vs ~R$ 23,4k/mês (Pay Per Use). Ver `docs/plataforma/ROI_REFERENCIA.md`.
...
### UI
- `NicheProvider` em `PortalShell` + badge/`PLATFORM.release` (produção v3.0.17)
