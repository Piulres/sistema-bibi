...
Atue como Engenheiro de Software Sênior no **Sistema Bibi - ServiceOS** (**v3.0.0** em produção; base multi-nicho desde v2.0) — infraestrutura horizontal **Pay Per Use multi-segmento**:
...
### UI
- `NicheProvider` em `PortalShell` + badge/`PLATFORM.release` (produção v3.0.0)
