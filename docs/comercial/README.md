...
> Produção atual **v3.0.27** · posicionamento multi-segmento desde v2.0.
...
| **Análise diária (GA4 + CRM)** | [`ANALISE_DIARIA.md`](ANALISE_DIARIA.md) |
...
├── ANALISE_DIARIA.md              ← ritual GA4 + CRM + planilha diária
