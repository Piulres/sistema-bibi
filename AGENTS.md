...
### O que é o Sistema Bibi - ServiceOS (v3.0.1)
...
Paletas white label por nicho. Ver `docs/versoes/V2_5.md`, `docs/versoes/V2_4.md`, `docs/versoes/V2_0.md` e `docs/versoes/V2_0_ARCHITECTURE.md`.
...
**Produção:** **`v3.0.0`** @ https://sistema-bibi.netlify.app (deploy pendente **v3.0.1**) · PWA `/instalar` · CEDIG + login tenant/portal · ver `docs/versoes/RELEASES.md` · `V3_0.md`.
...
**Versões:** `1.0.x` histórico — `docs/versoes/V1_0.md`. **`main`:** **`v3.0.1`** · Produção: **`v3.0.0`** — `docs/versoes/V3_0.md` · `V2_6.md` · `docs/versoes/RELEASES.md`.
