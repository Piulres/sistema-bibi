...
### O que é o Sistema Bibi - ServiceOS (v2.5.0)
...
**Produção:** **`v2.4.0`** @ https://sistema-bibi.netlify.app · código **`v2.5.0`** (login tenant/portal, pendente deploy) · ver `docs/versoes/RELEASES.md`.
...
**Versões:** `1.0.x` histórico — `docs/versoes/V1_0.md`. Código: **`v2.5.0`** — `docs/versoes/V2_5.md`. Produção: **`v2.4.0`** até deploy — `docs/versoes/RELEASES.md`.
