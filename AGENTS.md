...
**Produção:** **`v2.4.0`** @ https://sistema-bibi.netlify.app · código **`v2.6.0`** (CEDIG pontes + login v2.5, pronto para deploy) · ver `docs/versoes/RELEASES.md`.
...
**Versões:** `1.0.x` histórico — `docs/versoes/V1_0.md`. Código: **`v2.6.0`** — `docs/versoes/V2_6.md` · `V2_5.md`. Produção: **`v2.4.0`** até deploy — `docs/versoes/RELEASES.md`.
