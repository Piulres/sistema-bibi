...
### O que é o Sistema Bibi - ServiceOS (v2.4.0)
...
Paletas white label por nicho. Ver `docs/versoes/V2_4.md`, `docs/versoes/V2_3.md`, `docs/versoes/V2_0.md` e `docs/versoes/V2_0_ARCHITECTURE.md`.
...
**Versões:** `1.0.x` histórico — `docs/versoes/V1_0.md`. Produção: **`v2.4.0`** — `docs/versoes/V2_4.md` · `docs/versoes/V2_3.md` · `docs/versoes/RELEASES.md`.
...
|--------|--------|-----|-------------|
| Interno | `src/app/interno/layout.tsx` | `InternoNav` — **14 abas** + drawer mobile | Cliente 360° (`buildPatientBreadcrumbs`) |
