...
### O que é o Sistema Bibi - ServiceOS (v3.0.3)
...
**Produção:** **`v3.0.3`** @ https://sistema-bibi.netlify.app · PWA `/instalar` · CEDIG + login tenant/portal · ver `docs/versoes/RELEASES.md` · `V3_0.md`.
...
**Versões:** `1.0.x` histórico — `docs/versoes/V1_0.md`. Produção: **`v3.0.3`** — `docs/versoes/V3_0.md` · `V2_6.md` · `docs/versoes/RELEASES.md`.
