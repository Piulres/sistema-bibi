# Sistema Bibi - ServiceOS v3.0.1 — Infraestrutura Pay Per Use Multi-Nicho
...
| | |
|--|--|
| **Produção** | [sistema-bibi.netlify.app](https://sistema-bibi.netlify.app) · **v3.0.1** · deploy `bibi-poc-2026-07-26a` · PWA `/instalar` |
| **Código** | `main` = `dev` · tag `v3.0.1` |
...
> Description: `Sistema Bibi - ServiceOS v3.0.1 — PWA mobile + Pay Per Use multi-nicho`  
...
- **Netlify em produção** — https://sistema-bibi.netlify.app · pacote **v3.0.1** (ver [`RELEASES.md`](docs/versoes/RELEASES.md)).
...
- **Changelog v3.0.1 (produção atual):**
...
Construído como POC evoluindo para **Sistema Bibi - ServiceOS v3.0.1** — infraestrutura horizontal Pay Per Use multi-nicho com PWA mobile (piloto CEDIG).
