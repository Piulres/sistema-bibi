# Sistema Bibi - ServiceOS v3.0.8 — Infraestrutura Pay Per Use Multi-Nicho
...
| | |
|--|--|
| **Produção** | [sistema-bibi.netlify.app](https://sistema-bibi.netlify.app) · **v3.0.8** · deploy `bibi-poc-2026-07-26i` (`6a668d13`) · PWA `/instalar` |
| **Código** | `main` = `dev` · tag `v3.0.8` |
...
> Description: `Sistema Bibi - ServiceOS v3.0.8 — PWA mobile + Pay Per Use multi-nicho`  
...
- **Netlify em produção** — https://sistema-bibi.netlify.app · pacote **v3.0.8** (ver [`RELEASES.md`](docs/versoes/RELEASES.md)).
...
- **Changelog v3.0.x (produção atual v3.0.8):**
...
Construído como POC evoluindo para **Sistema Bibi - ServiceOS v3.0.8** — infraestrutura horizontal Pay Per Use multi-nicho com PWA mobile (piloto CEDIG).
